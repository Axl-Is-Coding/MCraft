...
data class PlayerMovementInput(
   // Status: Uncomfirmed - 2 possibilities. Either a script checks if these are true and executes script to walk or do something or it's enabled by the scripts that handle movement so that other script knows whats happening.
